...
java -javaagent:/app/jmx_prometheus_javaagent-0.19.0.jar=19090:/app/config.yaml -jar -DCONDUCTOR_CONFIG_FILE=$config_file conductor-server-*-boot.jar 2>&1| tee -a /app/logs/server.log
